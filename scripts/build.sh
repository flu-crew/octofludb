...
file="${DATADIR}/A0_2019-07-21.xlsx"
...
time d79 load_table "${DATADIR}/fair/2016.xlsx" --exclude="dnaseq,proseq" --tag=fair> ttl/fair2016.ttl
time d79 load_table "${DATADIR}/fair/2017.xlsx" --exclude="dnaseq,proseq" --tag=fair> ttl/fair2017.ttl
time d79 load_table "${DATADIR}/fair/2018.xlsx" --exclude="dnaseq,proseq" --tag=fair> ttl/fair2018.ttl
