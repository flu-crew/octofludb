...
# time d79 load_excel "${DATADIR}/fair/2016.xlsx" > ttl/fair2016.ttl --tag=fair
# time d79 load_excel "${DATADIR}/fair/2017.xlsx" > ttl/fair2017.ttl --tag=fair
# time d79 load_excel "${DATADIR}/fair/2018.xlsx" > ttl/fair2018.ttl --tag=fair
#
#
# file="${DATADIR}/pdm-2019.fasta"
# log "Loading $file"
# time d79 load_fasta "$file" --tag="pdm-2019" --delimiter="|" > ttl/pdm-2019.ttl
